...
駅スナップ: S12ホーム線形両端点 → NE/NW/SE/SW 4象限スナップ（スナップ駅ノード数: 66,269）
アクセスリンク: 孤立成分ノード除外（1,284,078件 / 42,537成分を除外・最大連結成分 17,329,986ノード）

| カテゴリ | 人口 | 割合 |
|---|---|---|
| 公共交通便利地域 | 5,469万人 | 43.4% |
| 公共交通不便地域 | 4,730万人 | 37.6% |
| **公共交通空白地域** | **2,395万人** | **19.0%** |

65歳以上では **758万人**（高齢者全体の21.5%）が空白地域に居住。
...
|---|---|---|
| **公共交通空白地域 人口** | **約735万人（5.8%）** | **約2,395万人（19.0%）** |
...
- 駅: S12ホーム線形の両端点 → NE/NW/SE/SW 4象限の最近傍ノードにスナップ（最大500m）
  - 線路をまたいだ東西口・南北口を確実にカバーする実装（例: 北松戸駅西口問題への対応）
  - 1端点あたり最大4ノード → 1駅あたり最大8ノード（重複除去後）
